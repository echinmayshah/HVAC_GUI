...
# Configure number of motor drives, Supported values : 1-2
# Number motor driver suppored varies on target deviced  
DEFINES+=MOTOR_CTRL_NO_OF_MOTOR=0x02
...
CY_IGNORE+=$(wildcard ../mtb_shared/motor-ctrl-lib/*/OperationalCode/SensorIface*)

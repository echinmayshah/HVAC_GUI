...
#ifndef OPERATIONALCODE_STATEMACHINE_H_
#define OPERATIONALCODE_STATEMACHINE_H_
...
typedef enum
{
    ...
    Prof_Finished,  // Profiler, finished
    Prof_Rot_Lock,  // Profiler, rotor locking
    Prof_R,         // Profiler, stator resistance estimation
...
#endif /* OPERATIONALCODE_STATEMACHINE_H_ */
